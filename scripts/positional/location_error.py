...
_columns = ['test0', 'test1', 'test2', 'pass0', 'pass1', 'pass2', 'bssid', 'sample0', 'sample1', 'sample2', 'samples', 'ray0_p_lat', 'ray0_p_lon', 'ray0_d_lat', 'ray0_d_lon', 'ray1_p_lat', 'ray1_p_lon', 'ray1_d_lat', 'ray1_d_lon', 'ray2_p_lat', 'ray2_p_lon', 'ray2_d_lat', 'ray2_d_lon', 'guess_lat', 'guess_lon', 'error_lat', 'error_lon', 'error_distance', 'mean_origin_distance']
...
def batch_prep(t):
    ...
    for param in params:
        ...
        try: 
            ...
            # Determine Median Origin
            median_origin = np.stack(ray_start_positions).mean(axis=0).ravel()
            median_origin_distance = distance(guess, median_origin)
            ...
            _result += guess.tolist() + error.ravel().tolist() + [error_distance, median_origin_distance]
